...
typedef struct gcrp_leave_s gcrp_leave_t;
...
typedef int gcrp_funptr_t(int type, void *payload, int length, void *privdata);
...
static gcrp_handler_t gcrp_handlers[GCRP_MSG_NUM]; 
