...
typedef int gcrp_funptr_t(int type, void *payload, int length, void *privdata, void *roomdata);
...
int gcrp_register_handler(gcrp_handtab_t *,int msgtype, gcrp_funptr_t *fun, void *privdata);
